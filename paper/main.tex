...
% In this paper we claim that problems of PM arise
% due to an incorrect understanding of rotational activity in cardiac fibrillation.
% Specifically, we claim that the concept of phase singularity is incomplete,
% as there is always a finite surface around which electrical activity rotates.
