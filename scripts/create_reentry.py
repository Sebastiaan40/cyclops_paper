...
tissue.mesh[n // 2 - 64 : n // 2 + 64, n // 2 - 64 : n // 2 + 64] = 0
tissue.conductivity = 0.2

# set up stimulation parameters:
stim_sequence = fw.StimSequence()
stim_sequence.add_stim(fw.StimVoltageCoord2D(70, 1, 0, n // 2 - 64, 0, n // 2 - 64))

# set up tracker:
tracker_sequence = fw.TrackerSequence()
animation_tracker = fw.Animation2DTracker()
animation_tracker.variable_name = "u"
animation_tracker.dir_name = "data/reentry"
...
shutil.move("data/animation.mp4", "videos/reentry.mp4")
