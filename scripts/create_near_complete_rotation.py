...
tissue.mesh[n // 4 - 40 : n // 4 + 40, n // 2 - 40 : n // 2 + 40] = 0
...
stim_sequence.add_stim(
    fw.StimVoltageCoord2D(70, 1, n // 4 + 32, 3*n // 4 - 64, 0, n // 2)
)
...
u_tracker.dir_name = "data/near_complete_rotation/u"
u_tracker.step = 20
...
v_tracker.dir_name = "data/near_complete_rotation/v"
v_tracker.step = 20
...
# calculate phase:
output_dir = Path("data/near_complete_rotation/phase")
